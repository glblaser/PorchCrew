...
exports.User = User;
},{"mithril":"../node_modules/mithril/index.js"}],"client/views/UserList.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  oninit: _User.User.loadList,
  view: function view() {
    // TODO add code 
    return (0, _mithril.default)('.user-list', _User.User.list.map(function (user) {
...
},{"mithril":"../node_modules/mithril/index.js","../models/User.js":"client/models/User.js"}],"client/views/UserForm.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  oninit: function oninit(vnode) {
    _User.User.load(vnode.attrs.id);
  },
  view: function view() {
    return (0, _mithril.default)("form", {
      onsubmit: function onsubmit(e) {
        e.preventDefault();

        _User.User.save();
      }
    }, [(0, _mithril.default)("label.label", "First name"), (0, _mithril.default)("input.input[type=text][placeholder=First name]", {
      oninput: function oninput(e) {
        _User.User.current.firstName = e.target.value;
      },
      value: _User.User.current.firstName
    }), (0, _mithril.default)("label.label", "Last name"), (0, _mithril.default)("input.input[placeholder=Last name]", {
      oninput: function oninput(e) {
        _User.User.current.lastName = e.target.value;
      },
      value: _User.User.current.lastName
    }), (0, _mithril.default)("button.button[type=submit]", "Save")]);
  }
};
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js","../models/User.js":"client/models/User.js"}],"client/views/Layout.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  view: function view(vnode) {
    return (0, _mithril.default)("main.layout", [(0, _mithril.default)("nav.menu", [(0, _mithril.default)(_mithril.default.route.Link, {
      href: "/list"
    }, "Users")]), (0, _mithril.default)("section", vnode.children)]);
  }
};
exports.default = _default;
},{"mithril":"../node_modules/mithril/index.js"}],"client/index.js":[function(require,module,exports) {
"use strict";

var _mithril = _interopRequireDefault(require("mithril"));

var _UserList = _interopRequireDefault(require("./views/UserList"));

var _UserForm = _interopRequireDefault(require("./views/UserForm"));
...
// src/index.js
_mithril.default.route(document.body, '/list', {
  '/list': {
    render: function render() {
      return (0, _mithril.default)(_Layout.default, (0, _mithril.default)(_UserList.default));
    }
  },
  '/edit/:id': {
    render: function render(vnode) {
      return (0, _mithril.default)(_Layout.default, (0, _mithril.default)(_UserForm.default, vnode.attrs));
    }
  }
});
},{"mithril":"../node_modules/mithril/index.js","./views/UserList":"client/views/UserList.js","./views/UserForm":"client/views/UserForm.js","./views/Layout":"client/views/Layout.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/client.3ede9662.js.map